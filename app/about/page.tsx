    ...
    <div className="bg-brand-background text-brand-text min-h-screen pt-16">
      <div className="mx-auto max-w-4xl px-6 lg:px-8 py-24 sm:py-32">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight font-header text-brand-text sm:text-6xl">About Me</h1>
        ...
        <div className="mx-auto mt-20 max-w-3xl space-y-16">
          {experiences.map((experience) => (
            <article key={experience._id} className="relative isolate group">
              ...
              <p className="mt-3 text-sm font-semibold leading-6 text-brand-accent font-body">{experience.category}</p>
              <p className="mt-4 text-base leading-7 text-brand-text/80 font-body">{experience.description}</p>
            </article>
          ))}
        </div>
      </div>
